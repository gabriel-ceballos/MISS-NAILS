const vistaCatalogoMobile = {
    ...
    async mostrar() {
        ...
        /*
         * ============================================
         * PRIMERO: COMPROBAR SI HAY UN DETALLE
         * PERSISTIDO.
         *
         * Esto debe ocurrir ANTES de construir
         * el catálogo y ANTES de consultar la API.
         * ============================================
         */
...
if (
    estadoGuardado &&
    estadoGuardado.pantalla === "MOBILE" &&
    estadoGuardado.vista === "detalle" &&
    estadoGuardado.producto
) {

    console.log(
        "MOBILE → último estado: DETALLE"
    );
    ...
    console.log(
        "MOBILE → detalle restaurado sin reconstruir catálogo"
    );
    ...
    return;
        ...
        /*
         * ============================================
         * NO HAY DETALLE PERSISTIDO.
         *
         * Ahora sí construimos el catálogo normal.
         * ============================================
         */
    ...
    async sincronizarProductos() {
        ...
        try {
             ...
             * pero NO reconstruimos el catálogo
             * sobre el detalle.
             */
            ...
            if (this.vistaActual === "detalle") {
                ...
                console.log(
                    "MOBILE → inventario actualizado durante detalle:",
            ...
            /*
             * En catálogo sí actualizamos la zona
             * de productos.
             */
...
mostrarDetalleProducto(producto, restaurado = false) {
...
// Referencia global de la nueva vista de catálogo.
window.vistaCatalogoMobile = vistaCatalogoMobile;
